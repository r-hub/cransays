...
make a [dashboard](https://r-hub.github.io//dashboard.html).
...
cran_incoming <- take_snapshot()
```

We render this as a [handy dashboard](https://r-hub.github.io//dashboard.html) that we update every hour via [GitHub Actions](https://github.com/r-hub/cransays/actions).
